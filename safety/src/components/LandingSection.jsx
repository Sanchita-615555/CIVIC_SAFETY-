    ...
    >
      ...
      <div className="flex flex-col md:flex-row flex-1">
        ...
        <div className="
          ...
          py-10 md:py-0
        ">
          <span className="text-sm lg:text-base xl:text-lg font-semibold text-blue-800 tracking-wide">
          ...
          <div className="mt-6 flex gap-4 flex-wrap">
            <a
              href="#contact"
              className="px-6 py-3 text-sm md:text-base lg:text-lg bg-blue-900 text-white rounded-md"
            >
              Get Involved
            </a>
            ...
            <a
              href="#about"
              className="px-6 py-3 text-sm md:text-base lg:text-lg border border-blue-900 text-blue-900 rounded-md"
            >
              Learn More
            </a>
          </div>
        ...
        {/* RIGHT IMAGE SLIDER */}
        <div className="md:w-1/2 relative h-[300px] sm:h-[350px] md:h-auto">
